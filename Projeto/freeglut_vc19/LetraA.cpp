...
void LetraA::setValores(float aresta,float grosura )
{
	a = aresta;
	b = grosura;
	...
	tri[1][0] = 0; tri[1][1] = 3*a-b*3; tri[1][2] = 0;
	tri[2][0] = -a+b; tri[2][1] = 0; tri[2][2] = 0;

	//Triangulo2
	tri[3][0] = -a; tri[3][1] = 0; tri[3][2] = 0;
	tri[4][0] = 0; tri[4][1] = 3*a; tri[4][2] = 0;
	tri[5][0] = 0; tri[5][1] = 3*a-b*3; tri[5][2] = 0;

	//Triangulo3 e Perna direita
	tri[6][0] = a; tri[6][1] = 0; tri[8][2] = 0;
	tri[7][0] = a-b; tri[7][1] = 0; tri[7][2] = 0;
	tri[8][0] = 0; tri[8][1] = 3*a-b*3; tri[6][2] = 0;

	//Triangulo4
	tri[9][0] = a; tri[9][1] = 0; tri[9][2] = 0;
	tri[10][0] = 0; tri[10][1] = 3*a-b*3; tri[10][2] = 0;
	tri[11][0] = 0; tri[11][1] = 3*a; tri[11][2] = 0;

	//Triangulo5 e traço do meio
	tri[12][0] = -a+b+(a/8); tri[12][1] = a/2; tri[12][2] = 0;
	tri[13][0] = -a + b + (a / 8) +(b/3); tri[13][1] = (a/2)+b; tri[13][2] = 0;
	tri[14][0] = a - b - (a / 8); tri[14][1] = a / 2; tri[14][2] = 0;

	//Triangulo6
	tri[15][0] = a - b - (a / 8); tri[15][1] = a/2; tri[15][2] = 0;
	tri[16][0] = -a + b + (a / 8) + (b /3); tri[16][1] = (a / 2)+b; tri[16][2] = 0;
	tri[17][0] = a - b - (a / 8) - (b/3 ); tri[17][1] = (a / 2) + b; tri[17][2] = 0;
}
